...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    public ConvenientBanner setPageIndicator(int[] page_indicatorId) {
        ...
        for (int count = 0; count < mDatas.size(); count++) {
            ...
            // TODO 修改源码 start ##################################
            LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(DensityUtil.dip2px(getContext(), 10),
                    DensityUtil.dip2px(getContext(), 10));
            if (count != 0) {
                params.setMargins(DensityUtil.dip2px(getContext(), 12), 0, 0, 0);
            }
            pointView.setLayoutParams(params);
//            pointView.setPadding(12, 0, 12, 0);
            // TODO 修改源码 end ##################################
